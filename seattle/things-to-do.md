...
The easiest way to rent bikes or scooters is using the Uber app. You can locate and unlock the bike using your phone and you can leave them anywhere (you pay an hourly rate). Seattle is very hilly, so the bike ride will give you a serious workout: generally the worst hills are when going east to west, while north to south is flatter. The main roads usually have dedicated bike lanes.
